...
function getProperty($var){
  ...
  if($var == 'key') Return 'Xo0uuSRGCxoQ2kaR'; 
	if($var == 'password') Return '83Oq1R5qlwEmd0y07641VmMTb'; 
	if($var == 'meter') Return '112997651';
	if($var == 'shipaccount') Return '143915077';

	if($var == 'billaccount') Return '143915077';
	if($var == 'dutyaccount') Return 'XXX2'; 
	if($var == 'freightaccount') Return '143915077';  
	if($var == 'trackaccount') Return 'XXX5'; 
	if($var == 'dutiesaccount') Return 'XXX6';
	if($var == 'importeraccount') Return 'XXX7';
	if($var == 'brokeraccount') Return 'XXX8';
	if($var == 'distributionaccount') Return 'XXX9';
	if($var == 'locationid') Return 'PLBA';
	if($var == 'printlabels') Return true;
	if($var == 'printdocuments') Return true;
	if($var == 'packagecount') Return '4';
	if($var == 'validateaccount') Return 'XXX10';
